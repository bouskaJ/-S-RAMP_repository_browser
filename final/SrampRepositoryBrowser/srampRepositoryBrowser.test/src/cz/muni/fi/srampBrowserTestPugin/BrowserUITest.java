...
public class BrowserUITest {
	...
	public static void beforeClass() throws Exception {
		...
		bot.tree().getTreeItem("Test").select().contextMenu("New").menu("File").click();
	...
	public void repositoryBrowserTest()
	{
		...
		bot.tree().getTreeItem("Test").getNode("Test").select().contextMenu("Import to S-RAMP repository").click();
		bot.button("OK").click();
		...
		bot.table().getTableItem("file").select().contextMenu("Import to workspace").click();
